...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `sex`, `username`, `password`, `email`, `phone`, `type`, `status , original_password`) VALUES
(1, 'System', 'Administrator', 'Male', 'admin', '0192023a7bbd73250516f069df18b500', 'admin@bloodbank.com', '123456789', 1, 1 , 'admin123');
